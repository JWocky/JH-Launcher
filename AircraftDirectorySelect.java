...
public class AircraftDirectorySelect extends JPanel implements ActionListener, ListSelectionListener {
	...
	public AircraftDirectorySelect(Configuration c) {
		config=c;
	...
	private void loadAircraftDirectories() {
